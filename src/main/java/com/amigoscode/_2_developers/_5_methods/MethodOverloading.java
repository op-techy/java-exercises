...
public class MethodOverloading {
    ...
    public static void main(String[] args) {
        ...
        //  - add(1.5, 2.5)
        System.out.println("The sum of 1.5 and 2.5 is: " + mo.add(1.5,2.5));
        //  - format("hello")
        System.out.println("Formatting gives: " + mo.format("hello"));
        //  - format(42)
        System.out.println("Formatting gives: " + mo.format(42));
        //  - format("Score", 95)
        System.out.println("Formatting gives: " + mo.format("Score",95));
