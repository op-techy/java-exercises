...
public class ClassesAndObjects {
    ...
    public static void main(String[] args) {
        ...
        Person manny = new Person();
        Person alicia = new Person("Alice", 30);
        IO.println(alice);
        IO.println(manny);
        IO.println(alicia);
        IO.println(alice.equals(alicia));



        // TODO: 7 - Demonstrate constructor chaining with this():
        //  When a constructor references an already existing constructor in itself
        ...
        IO.println("No-args person: " + manny);
