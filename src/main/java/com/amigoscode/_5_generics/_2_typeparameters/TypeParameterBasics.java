...
public class TypeParameterBasics {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("The compiler rejects the value '123' in stringContainer because the Type " +
                "parameter has been defined as String but the argument passed is not a String");
